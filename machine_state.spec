...
a = Analysis(
    ...
    hiddenimports=[
        ...
        # Phase 9 subpackages
        "machine_state.tui.dashboard",
        "machine_state.cleanup.scanner",
        "machine_state.cleanup.estimator",
        "machine_state.cleanup.executor",
        "machine_state.digest.generator",
        "machine_state.digest.formatter",
        "machine_state.alerts.loader",
        "machine_state.alerts.evaluator",
        "machine_state.alerts.dispatcher",
        "machine_state.session",
        "machine_state.health",
        "machine_state.app_report",
        "machine_state.diff",
    ],
    hookspath=[],
    hooksconfig={},
